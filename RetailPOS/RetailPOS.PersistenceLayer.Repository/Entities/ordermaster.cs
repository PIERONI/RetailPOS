...
namespace RetailPOS.PersistenceLayer.Repository.Entities
{
    public partial class ordermaster : EntityBase
    {
        ...
        public virtual string ticket_no
        {
            get;
            set;
        }
        ...
        public virtual decimal total_discount
        {
            get;
            set;
        }
        ...
        public virtual decimal credit_amount
        {
            get;
            set;
        }
    
        public virtual Nullable<System.DateTime> payment_due_date
        {
            get;
            set;
        }
